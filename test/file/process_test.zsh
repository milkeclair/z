...
z.t.describe "z.file.make"; {
  z.t.context "ファイルが存在しない場合"; {
    z.t.it "ファイルを作成する"; {
      z.dir.make /tmp/z_t
      z.file.make /tmp/z_t/file_make.txt
  ...
  z.t.context "親ディレクトリが存在しない場合"; {
    z.t.it "何もしない"; {
      z.file.make /tmp/z_t/non_existent_dir/file_make.txt
...
z.t.describe "z.file.make_with_dir"; {
  z.t.context "ファイルが存在しない場合"; {
    z.t.it "ファイルを作成する"; {
      z.file.make_with_dir /tmp/z_t/file_make_with_dir.txt
  ...
  z.t.context "親ディレクトリが存在しない場合"; {
    z.t.it "親ディレクトリごとファイルを作成する"; {
      z.file.make_with_dir /tmp/z_t/non_existent_dir/file_make_with_dir.txt
