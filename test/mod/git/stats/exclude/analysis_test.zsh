...
z.t.describe "z.git.stats._exclude.exts"; {
  z.t.context "exclude_extsを渡した場合"; {
    z.t.it "そのまま返す"; {
      z.git.stats._exclude.exts exclude_exts="html css js"
...
z.t.describe "z.git.stats._exclude.dirs"; {
  z.t.context "exclude_dirsを渡した場合"; {
    z.t.it "そのまま返す"; {
      z.git.stats._exclude.dirs exclude_dirs="src app"
