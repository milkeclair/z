# printing colored and indented message without newline at the end
#
...
#
# example:
#  z.io.oneline.indent.color level=2 color=red "indented message" #=> prints "    indented message" in red color without newline
z.io.oneline.indent.color() {
  local args=($@)
  ...
  z.io.oneline.indent level=$level $REPLY
}
